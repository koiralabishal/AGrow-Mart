...
import '../../styles/common/ProfileEditForm.css';
    ...
    const fetchUserData = async () => {
      try {
        ...
        if (localUserData.profilePic) {
          setPreviewImage(getProfileImageUrl(localUserData.profilePic));
        }
        ...
        try {
          ...
          if (response && response.success) {
            ...
            if (apiUserProfile.profilePic && !previewImage) {
              setPreviewImage(getProfileImageUrl(apiUserProfile.profilePic));
            }
          }
        } catch (apiError) {
